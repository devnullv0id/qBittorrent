...
void AppController::preferencesAction()
{
    ...
    data[u"status_bar_free_disk_space"_s] = pref->isStatusbarFreeDiskSpaceDisplayed();
    // Transfer List
    ...
    data[u"close_search_tab_with_middle_click"_s] = pref->closeSearchTabWithMiddleClick();
    // Log file
...
void AppController::setPreferencesAction()
{
    ...
    if (hasKey(u"status_bar_free_disk_space"_s))
        pref->setStatusbarFreeDiskSpaceDisplayed(it.value().toBool());
    ...
    if (hasKey(u"close_search_tab_with_middle_click"_s))
        pref->setCloseSearchTabWithMiddleClick(it.value().toBool());
    // Log file
