...
inline const QString KEY_TORRENT_DHT_DISABLED = u"dht_disabled"_s;
inline const QString KEY_TORRENT_PEX_DISABLED = u"pex_disabled"_s;
inline const QString KEY_TORRENT_LSD_DISABLED = u"lsd_disabled"_s;
